    ...
    <footer class="py-3">
      <div class="container">
        <div class="copy-agile-right text-center">
          ...
          <p>
            © 2019 Sistem Informasi Katalog Buku Online</a>
          </p>
        </div>
      </div>
    </footer>
    ...
    <!--//js working-->
    <!--blast colors change-->
    <script src="<?php echo base_url()?>assets/front/js/blast.min.js"></script>
    <!--//blast colors change-->
    <!--responsiveslides banner-->
    <script src="<?php echo base_url()?>assets/front/js/responsiveslides.min.js"></script>
    <script>
