...
echo form_open_multipart(base_url('admin/file/edit/'.$file->id_file));
?>
...
<div class="form-group">
	<label>Upload File <small>(File lama: <a href="<?php echo base_url('admin/file/download/'.$file->id_file) ?>" target="_blank"> <i class="fa fa-download"></i> <?php echo $file->nama_file ?></a>)</small></label>
