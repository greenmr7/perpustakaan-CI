...
echo form_open(base_url('admin/buku/tambah'));
?>
...
<div class="col-lg-6">
  ...
  <div class="form-group form-group-lg">
    ...
    <input type="text" name="bukuname" class="form-control" placeholder="bukuname" value="<?php echo set_value('bukuname') ?>" required>
  </div>
  <div class="form-group form-group-lg">
